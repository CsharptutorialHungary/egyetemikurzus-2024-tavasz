...
{
    /// <inheritdoc />
    public partial class GroupRowId : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GROUPTECHNICALNAME = table.Column<Guid>(type: "RAW(16)", nullable: true, defaultValueSql: "(sys_guid()) ")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RowId = table.Column<decimal>(type: "DECIMAL(18, 2)", nullable: false),
                    USERID = table.Column<decimal>(type: "NUMBER(38)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("MEMBERROWID", x => x.RowId);
                    table.ForeignKey(
                        name: "SYS_C0010573",
                        column: x => x.USERID,
                        principalSchema: "SZABOKD",
