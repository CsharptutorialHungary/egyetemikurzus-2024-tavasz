    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    USERID = table.Column<int>(type: "INT", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    PERMISSIONID = table.Column<int>(type: "INT", nullable: true, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FRIENDID1 = table.Column<int>(type: "INT", nullable: true),
                    FRIENDID2 = table.Column<int>(type: "INT", nullable: true),
                    FRIEND_START_DATE = table.Column<string>(type: "VARCHAR2(100)", unicode: false, maxLength: 100, nullable: true),
                    IS_FRIEND = table.Column<int>(type: "INT", nullable: true)
                },
                constraints: table =>
                {
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PHOTO_URL = table.Column<string>(type: "VARCHAR2(1000)", unicode: false, maxLength: 1000, nullable: true),
                    PHOTO_SIZE = table.Column<int>(type: "INT", nullable: true)
                },
                constraints: table =>
                {
